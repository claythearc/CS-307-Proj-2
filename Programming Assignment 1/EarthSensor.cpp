...
EarthSensor::EarthSensor(int time, int id, double minValue, double maxValue,char* name, char* material, char* units) : 
...
std::vector<double> EarthSensor::getSensorData() {
    return this->value;
}

string EarthSensor::getSensorUnits() {
    return this->units;
}

int EarthSensor::getID() {
    return this->id;
}

int EarthSensor::getLatestData() {
	return this->value.back();
}

bool EarthSensor::setDisplay(Display d) {
